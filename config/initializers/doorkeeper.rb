Doorkeeper.configure do
  ...
  #   current_user || redirect_to(new_session_url(return_to: request.fullpath))
  # end
  resource_owner_authenticator do
  ...
  #     Doorkeeper::Application.find_by(controller.request.params.slice(:redirect_uri)).logout_uri
  # end
